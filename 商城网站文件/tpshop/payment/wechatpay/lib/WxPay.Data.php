...
class WxPayDataBase
{
	...
	**/
	...
	{	
        ...
        //将XML转为array
        //禁止引用外部xml实体
        libxml_disable_entity_loader(true);//禁用加载外部xml实体的功能
        $this->values = json_decode(json_encode(simplexml_load_string($xml, 'SimpleXMLElement', LIBXML_NOCDATA)), true);
		return $this->values;//simpexml_load_string()将XML字符串解释为对象
	}
...
{	
	...
	**/
	...
	{
		return array_key_exists('goods_tag', $this->values);//array_key_exists()检测是否存在键值或索引
	}
